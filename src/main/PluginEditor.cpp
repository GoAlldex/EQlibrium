...
EQlibriumAudioProcessorEditor::EQlibriumAudioProcessorEditor (EQlibriumAudioProcessor& p)
    ...
    filterLeft(audioProcessor, 0),
    freqLeft(audioProcessor, 0),
    ...
    filterRight(audioProcessor, 1),
    freqRight(audioProcessor, 1),
    levelMeterLeft(audioProcessor, 0),
    levelMeterRight(audioProcessor, 1),
...
void EQlibriumAudioProcessorEditor::resized() {
    ...
    // Replay Button
    auto replay = juce::Rectangle(449, window_micro_rect.getHeight()/2-25, 50, 50);
