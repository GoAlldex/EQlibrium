...
//==============================================================================
const juce::String EQlibriumAudioProcessor::getName() const
{
...
double EQlibriumAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int EQlibriumAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int EQlibriumAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
const juce::String EQlibriumAudioProcessor::getProgramName (int index)
{
    return {};
}
...
//==============================================================================
bool EQlibriumAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* EQlibriumAudioProcessor::createEditor() {
    //return new EQlibriumAudioProcessorEditor (*this);
...
void EQlibriumAudioProcessor::updateCoefficients(Coefficients &old, const Coefficients &replacements) {
    *old = *replacements;
}
...
{
    return new EQlibriumAudioProcessor();
}